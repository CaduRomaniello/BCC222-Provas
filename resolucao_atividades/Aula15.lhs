...
\begin{code}
-- Nesse exercicio foram utilizadas as orientações forncecidas no slack, quando a string possui apenas parenteses ela funciona perfeitamente, porém quando a string fornecida possui alguns caracteres a mais ela apresenta um comportamento estranho que eu não consegui identificar o motivo
